...
- Se conoce como un lenguaje orientado objetos, se pueden utilizar múltiples paquetes mediante sus librerias para trabajarlos. 
--


- Existe una interfaz básica con la *consola* que permite realizar programación (Rgui).
--
...
Para más detalles visitar <http://adv-r.had.co.nz/Vocabulary.html>
]
...
#install.packages("carData") instalarlo si no está
library(carData)
